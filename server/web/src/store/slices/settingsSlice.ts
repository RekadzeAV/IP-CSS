...
export const fetchSystemSettings = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(getErrorMessage(error, 'Failed to fetch system settings'));
    }
  }
);
...
export const updateSetting = createAsyncThunk(
  ...
  async ({ key, value }: { key: string; value: string }, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(getErrorMessage(error, 'Failed to update setting'));
    }
  }
);
...
export const deleteSetting = createAsyncThunk(
  ...
  async (key: string, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(getErrorMessage(error, 'Failed to delete setting'));
    }
  }
);
...
export const exportSettings = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(getErrorMessage(error, 'Failed to export settings'));
    }
  }
);
...
export const importSettings = createAsyncThunk(
  ...
  async (settings: Record<string, string>, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(getErrorMessage(error, 'Failed to import settings'));
    }
  }
);
...
export const resetSettings = createAsyncThunk(
  ...
  async (category: string | undefined, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(getErrorMessage(error, 'Failed to reset settings'));
    }
  }
);
