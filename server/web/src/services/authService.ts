...
import type { ApiResponse, LoginRequest, LoginResponse, RefreshTokenResponse, User } from '@/types';
...
export const authService = {
  ...
  /**
   * Обновить access token (refresh из httpOnly cookie).
   * Возвращает expiresIn (сек) для планировщика проактивного refresh.
   */
  async refreshToken(): Promise<number> {
    ...
    return response.data.data.expiresIn ?? 900;
  },
