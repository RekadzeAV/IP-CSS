...
const getMenuItems = (isAdmin: boolean) => [
  ...
  { text: 'Правила аналитики', icon: <RuleIcon />, path: '/analytics/rules' },
...
export default function Layout({ children }: LayoutProps) {
  ...
  const { connected, connecting, error: wsError } = useAppSelector((state) => state.websocket);
    ...
    <Box>
      ...
      <List>
        <ListItem disablePadding>
          <ListItemButton onClick={handleLogout} aria-label="Выйти из системы">
            <ListItemIcon>
              <LogoutIcon />
            </ListItemIcon>
          ...
          >
            ...
            >
              ...
              <Typography variant="caption" sx={{ display: { xs: 'none', sm: 'block' } }}>
                {connecting ? 'Подключение...' : connected ? 'Онлайн' : wsError ? 'Ошибка WS' : 'Офлайн'}
              </Typography>
            </Box>
          </Tooltip>
        </Toolbar>
