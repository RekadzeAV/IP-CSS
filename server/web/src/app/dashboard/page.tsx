...
import { EventsChart, CamerasChart, ChartContainer } from '@/components/Charts';
...
function DashboardContent() {
  ...
  const onlineCameras = camerasArray.filter((c) => c.status === 'ONLINE').length;
          ...
          <Grid container spacing={3} sx={{ mt: 2 }}>
            <Grid item xs={12} md={6}>
              <ChartContainer
                ...
                onExport={(format) => {
                  console.log('Export events chart:', format);
              ...
              >
                <EventsChart
                  ...
                  onDataPointClick={(data) => {
                    console.log('Event data point clicked:', data);
                    // TODO: Navigate to events page with filter
                  }}
                />
              </ChartContainer>
            </Grid>
            <Grid item xs={12} md={6}>
              <ChartContainer
                title="Статус камер"
                onRefresh={() => dispatch(fetchCameras())}
                onExport={(format) => {
                  console.log('Export cameras chart:', format);
                  // TODO: Implement export
                }}
              >
                <CamerasChart
                  ...
                  onSegmentClick={(data) => {
                    console.log('Camera segment clicked:', data);
                    // TODO: Filter cameras by status
                  }}
                />
              </ChartContainer>
            </Grid>
