...
function NotificationsContent() {
  ...
  const handleMarkAsRead = async (id: string) => {
    try {
      ...
      const message = error instanceof Error ? error.message : 'Ошибка при отметке уведомления';
  ...
  const handleMarkAllAsRead = async () => {
    ...
    try {
      ...
      const message = error instanceof Error ? error.message : 'Ошибка при отметке уведомлений';
      enqueueSnackbar(message, { variant: 'error' });
    }
  };
