...
class StorageService(
    ...
    data class StorageInfo(
        ...
        /**
         * Получить информацию о хранилище в виде строки для логирования
         */
        fun toLogString(): String {
            return "Storage: ${getFormattedUsed()}/${getFormattedTotal()} used " +
                   "(${String.format("%.1f", usagePercentage)}%), " +
                   "${getFormattedAvailable()} available" +
                   (quotaBytes?.let { ", Quota: ${getFormattedQuotaUsed()}/${getFormattedQuota()}" } ?: "")
        }
