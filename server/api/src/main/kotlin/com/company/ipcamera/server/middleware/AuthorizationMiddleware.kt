...
object AuthorizationMiddleware {
    ...
    suspend fun PipelineContext<Unit, ApplicationCall>.requireRole(
        ...
        val userRole = try {
            ...
            throw SecurityException("Access denied: invalid role")
        }
        ...
        if (!hasAccess) {
            ...
            throw SecurityException("Access denied: insufficient privileges")
        }
    }
    ...
    suspend fun PipelineContext<Unit, ApplicationCall>.requireAnyPermission(
        ...
        if (!hasAnyPermission) {
            ...
            SecurityLogger.logPermissionDenied(
                ...
                ipAddress = ipAddress,
                resource = call.request.path(),
                requiredPermission = permissions.joinToString(", ")
            )
            call.respond(
                HttpStatusCode.Forbidden,
                ApiResponse<Unit>(
