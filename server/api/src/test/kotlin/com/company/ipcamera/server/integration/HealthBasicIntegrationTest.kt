...
/**
 * Интеграционный smoke для [GET /api/v1/health]: структура ответа без жёсткой привязки к Redis/FFmpeg на машине CI.
 */
class HealthBasicIntegrationTest {

    @Test
    fun `GET api v1 health returns ApiResponse with checks`() = testApplication {
        application {
            stopKoin()
