# NAS Smoke Report Template — QNAP

**Platform:** QNAP QTS  
**Date:** YYYY-MM-DD  
**Tester:** <name>  
**Artifact:** `ip-css-Alfa-0.1.1-qnap-<arch>.qpkg`  
...
- ServiceShell lifecycle via App Center: `PASS|FAIL`
- `init.sh` registration and `uninstall.sh` cleanup: `PASS|FAIL`
