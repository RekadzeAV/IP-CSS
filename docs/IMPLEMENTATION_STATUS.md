...
- ⚠️ Интерфейсы других репозиториев (EventRepository, RecordingRepository, UserRepository, SettingsRepository, NotificationRepository)
- ⚠️ Заглушки реализаций других репозиториев (EventRepositoryImpl, RecordingRepositoryImpl, UserRepositoryImpl, SettingsRepositoryImpl, NotificationRepositoryImpl)
...
- ❌ Use Cases для записи, аналитики
