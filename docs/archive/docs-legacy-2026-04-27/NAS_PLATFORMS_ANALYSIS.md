...
> - **[docs/planning/NAS_PLATFORM_IMPLEMENTATION_PLAN.md](planning/NAS_PLATFORM_IMPLEMENTATION_PLAN.md)** - Поэтапный план реализации NAS платформы (4 фазы, 8 недель)
...
> - **[docs/DEPLOYMENT_GUIDE.md](DEPLOYMENT_GUIDE.md)** - Руководство по развертыванию (включая NAS)
