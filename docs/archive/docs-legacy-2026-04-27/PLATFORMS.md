...
- **UI:** Compose Desktop
- **Документация:**
  - [platforms/client-desktop-x86_64/README.md](../platforms/client-desktop-x86_64/README.md)
  - [platforms/client-desktop-x86_64/IMPLEMENTATION_STATUS.md](../platforms/client-desktop-x86_64/IMPLEMENTATION_STATUS.md) - Статус реализации (~70%)
  - [DESKTOP_DETAILED_PLAN.md](DESKTOP_DETAILED_PLAN.md) - Детальный план реализации
  - [DESKTOP_REFINEMENT_PLAN.md](DESKTOP_REFINEMENT_PLAN.md) - План доработки
