...
import com.company.ipcamera.android.ui.screens.notifications.NotificationsScreen
import com.company.ipcamera.android.ui.screens.recordings.RecordingPlaybackScreen
        ...
        composable("notifications") {
            NotificationsScreen(
                ...
                onNotificationClick = { notification ->
                    ...
                    when {
                        notification.cameraId != null -> {
                            navController.navigate("camera_detail/${notification.cameraId}")
                        }
                        notification.eventId != null -> {
                            navController.navigate("event_detail/${notification.eventId}")
                        }
                        notification.recordingId != null -> {
                            navController.navigate("recording_playback/${notification.recordingId}")
                        }
                    }
                }
            )
