...
class CameraRepositoryImplTest {
    ...
    @Test
    fun `test add camera success`() =
        runTest {
            // Arrange
            val camera =
                TestDataFactory.createTestCamera(
                    id = "camera-1",
                    name = "Test Camera",
                )
    ...
    @Test
    fun `test get camera by id not found`() =
        runTest {
            // Act
    ...
    @Test
    fun `test get all cameras empty`() =
        runTest {
            // Act
            val result = repository.getCameras()
    ...
    @Test
    fun `test update camera success`() =
        runTest {
            // Arrange
            val originalCamera =
                TestDataFactory.createTestCamera(
                    id = "camera-1",
                    name = "Original Name",
                    updatedAt = 1_000L, // фиксированное прошлое, чтобы гарантировать строгий рост updatedAt
                )
    ...
    @Test
    fun `test remove camera success`() =
        runTest {
            // Arrange
            val camera = TestDataFactory.createTestCamera(id = "camera-1")
            repository.addCamera(camera)
    ...
    @Test
    fun `test remove non-existent camera`() =
        runTest {
            // Act
    ...
    @Test
    fun `test get camera status not found`() =
        runTest {
            // Act
    ...
    @Test
    fun `test discover cameras returns list`() =
        runTest {
            // Arrange & Act
    ...
    @Test
    fun `test test connection returns result`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `test add multiple cameras and retrieve`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `test camera with all fields`() =
        runTest {
            // Arrange
            val camera =
                TestDataFactory.createTestCamera(
