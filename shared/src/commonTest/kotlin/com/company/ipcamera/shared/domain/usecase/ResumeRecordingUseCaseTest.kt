...
class ResumeRecordingUseCaseTest {
    @Test
    fun `test resume recording success`() =
        runTest {
            // Arrange
            val recording =
    ...
    @Test
    fun `test resume recording not found fails`() =
        runTest {
            // Arrange
            val repository = MockRecordingRepository()
            val useCase = ResumeRecordingUseCase(repository)
    ...
    @Test
    fun `test resume recording not paused fails`() =
        runTest {
            // Arrange
            val recording =
                TestDataFactory.createTestRecording(
    ...
    @Test
    fun `test resume recording completed fails`() =
        runTest {
            // Arrange
            val recording =
                TestDataFactory.createTestRecording(
    ...
    @Test
    fun `test resume recording repository failure`() =
        runTest {
            // Arrange
            val recording =
                TestDataFactory.createTestRecording(
