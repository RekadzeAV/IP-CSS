...
class DeleteRecordingUseCaseTest {
    @Test
    fun `test delete recording success`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `test delete recording with blank id fails`() =
        runTest {
            // Arrange
            val repository = MockRecordingRepository()
            val useCase = DeleteRecordingUseCase(repository)
    ...
    @Test
    fun `test delete recording not found fails`() =
        runTest {
            // Arrange
            val repository = MockRecordingRepository()
            val useCase = DeleteRecordingUseCase(repository)
    ...
    @Test
    fun `test delete recording repository failure`() =
        runTest {
            // Arrange
            val recording = TestDataFactory.createTestRecording(id = "recording-1")
            val repository = MockRecordingRepository()
