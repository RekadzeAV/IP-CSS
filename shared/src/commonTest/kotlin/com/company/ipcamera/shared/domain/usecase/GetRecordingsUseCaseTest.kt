...
class GetRecordingsUseCaseTest {
    @Test
    fun `test get recordings success`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `test get recordings empty list`() =
        runTest {
            // Arrange
            val repository = MockRecordingRepository()
            val useCase = GetRecordingsUseCase(repository)
    ...
    @Test
    fun `test get recordings filter by camera id`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `test get recordings pagination`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `test get recordings filter by time range`() =
        runTest {
            // Arrange
            ...
            val recording1 =
                TestDataFactory.createTestRecording(
                    id = "rec-1",
                    cameraId = "camera-1",
    ...
    @Test
    fun `test get recordings invalid page defaults to 1`() =
        runTest {
            // Arrange
            val recordings = TestDataFactory.createTestRecordings(5, "camera-1")
            val repository = MockRecordingRepository()
    ...
    @Test
    fun `test get recordings invalid limit defaults to 20`() =
        runTest {
            // Arrange
            val recordings = TestDataFactory.createTestRecordings(25, "camera-1")
            val repository = MockRecordingRepository()
    ...
    @Test
    fun `test get recordings limit exceeds max`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `test get recordings start time greater than end time throws exception`() =
        runTest {
            // Arrange
            val repository = MockRecordingRepository()
            val useCase = GetRecordingsUseCase(repository)
    ...
    @Test
    fun `test get recordings blank camera id ignored`() =
        runTest {
            // Arrange
