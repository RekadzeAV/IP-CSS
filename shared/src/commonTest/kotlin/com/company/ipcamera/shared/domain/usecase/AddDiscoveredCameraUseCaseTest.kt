...
class AddDiscoveredCameraUseCaseTest {
    @Test
    fun `test add discovered camera success`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `test add discovered camera with credentials`() =
        runTest {
            // Arrange
            val cameraRepository = MockCameraRepository()
            val addCameraUseCase = AddCameraUseCase(cameraRepository)
    ...
    @Test
    fun `test add discovered camera without credentials`() =
        runTest {
            // Arrange
            val cameraRepository = MockCameraRepository()
            val addCameraUseCase = AddCameraUseCase(cameraRepository)
    ...
    @Test
    fun `test add discovered camera with minimal data`() =
        runTest {
            // Arrange
            val cameraRepository = MockCameraRepository()
            val addCameraUseCase = AddCameraUseCase(cameraRepository)
    ...
    @Test
    fun `test add discovered camera repository failure`() =
        runTest {
            // Arrange
            val cameraRepository = MockCameraRepository()
