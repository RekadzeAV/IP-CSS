...
class StartRecordingUseCaseTest {
    @Test
    fun `test start recording success`() =
        runTest {
            // Arrange
            val camera =
    ...
    @Test
    fun `test start recording with blank camera id fails`() =
        runTest {
            // Arrange
            val cameraRepository = MockCameraRepository()
            val recordingRepository = MockRecordingRepository()
    ...
    @Test
    fun `test start recording camera not found fails`() =
        runTest {
            // Arrange
            val cameraRepository = MockCameraRepository()
            val recordingRepository = MockRecordingRepository()
    ...
    @Test
    fun `test start recording camera offline fails`() =
        runTest {
            // Arrange
            val camera =
                TestDataFactory.createTestCamera(
    ...
    @Test
    fun `test start recording with negative duration fails`() =
        runTest {
            // Arrange
            val camera =
                TestDataFactory.createTestCamera(
    ...
    @Test
    fun `test start recording with zero duration fails`() =
        runTest {
            // Arrange
            val camera =
                TestDataFactory.createTestCamera(
    ...
    @Test
    fun `test start recording repository failure`() =
        runTest {
            // Arrange
            val camera =
                TestDataFactory.createTestCamera(
    ...
    @Test
    fun `test start recording with different formats`() =
        runTest {
            // Arrange
            val camera =
                TestDataFactory.createTestCamera(
    ...
    @Test
    fun `test start recording with different qualities`() =
        runTest {
            // Arrange
            val camera =
                TestDataFactory.createTestCamera(
