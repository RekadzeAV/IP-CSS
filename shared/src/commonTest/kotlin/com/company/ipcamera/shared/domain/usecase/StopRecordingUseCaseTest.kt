...
class StopRecordingUseCaseTest {
    @Test
    fun `test stop recording success`() =
        runTest {
            // Arrange
            val recording =
    ...
    @Test
    fun `test stop recording with blank id fails`() =
        runTest {
            // Arrange
            val repository = MockRecordingRepository()
            val useCase = StopRecordingUseCase(repository)
    ...
    @Test
    fun `test stop recording not found fails`() =
        runTest {
            // Arrange
            val repository = MockRecordingRepository()
            val useCase = StopRecordingUseCase(repository)
    ...
    @Test
    fun `test stop recording already completed fails`() =
        runTest {
            // Arrange
            val recording =
                TestDataFactory.createTestRecording(
    ...
    @Test
    fun `test stop recording paused fails`() =
        runTest {
            // Arrange
            val recording =
                TestDataFactory.createTestRecording(
    ...
    @Test
    fun `test stop recording repository failure`() =
        runTest {
            // Arrange
            val recording =
                TestDataFactory.createTestRecording(
    ...
    @Test
    fun `test stop recording calculates duration correctly`() =
        runTest {
            // Arrange
