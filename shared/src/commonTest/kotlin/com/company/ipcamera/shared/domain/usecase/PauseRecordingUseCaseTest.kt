...
class PauseRecordingUseCaseTest {
    @Test
    fun `test pause recording success`() =
        runTest {
            // Arrange
            val recording =
    ...
    @Test
    fun `test pause recording not found fails`() =
        runTest {
            // Arrange
            val repository = MockRecordingRepository()
            val useCase = PauseRecordingUseCase(repository)
    ...
    @Test
    fun `test pause recording already paused fails`() =
        runTest {
            // Arrange
            val recording =
                TestDataFactory.createTestRecording(
    ...
    @Test
    fun `test pause recording completed fails`() =
        runTest {
            // Arrange
            val recording =
                TestDataFactory.createTestRecording(
    ...
    @Test
    fun `test pause recording repository failure`() =
        runTest {
            // Arrange
            val recording =
                TestDataFactory.createTestRecording(
