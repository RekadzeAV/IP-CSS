...
class DiscoverAndAddCameraUseCaseTest {
    ...
    @Test
    fun `test discover and add cameras auto add true adds all discovered`() =
        runTest {
            // Arrange
            val cameraRepository = MockCameraRepository()
    ...
    @Test
    fun `test discover and add cameras with credentials`() =
        runTest {
            // Arrange
            val cameraRepository = MockCameraRepository()
            val discoverUseCase = DiscoverCamerasUseCase(cameraRepository)
    ...
    @Test
    fun `test discover and add cameras result properties`() =
        runTest {
            // Arrange
            val cameraRepository = MockCameraRepository()
            val discoverUseCase = DiscoverCamerasUseCase(cameraRepository)
