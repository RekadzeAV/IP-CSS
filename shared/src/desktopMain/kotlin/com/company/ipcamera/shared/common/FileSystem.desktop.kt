...
actual class FileSystem actual constructor(context: Any?) {
    ...
    private val _documentsDirectory: String by lazy {
    ...
    private val _cacheDirectory: String by lazy {
        val os = System.getProperty("os.name", "").lowercase()
        when {
            os.contains("win") -> {
    ...
    private val _tempDirectory: String by lazy {
        System.getProperty("java.io.tmpdir") ?: "/tmp"
    }

    actual fun getDocumentsDirectory(): String = _documentsDirectory

    actual fun getCacheDirectory(): String = _cacheDirectory

    actual fun getTempDirectory(): String = _tempDirectory
    ...
    actual suspend fun createDirectory(path: String): Boolean =
        withContext(Dispatchers.IO) {
            try {
                ...
                val allowedDirs = listOf(_documentsDirectory, _cacheDirectory, _tempDirectory)
                val validatedPath =
                    PathSecurity.validateAndNormalizePath(path, _documentsDirectory)
