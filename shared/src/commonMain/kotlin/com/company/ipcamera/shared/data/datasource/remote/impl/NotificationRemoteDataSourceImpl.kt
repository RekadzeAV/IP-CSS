...
class NotificationRemoteDataSourceImpl(
    ...
    override suspend fun getNotifications(
        ...
        withContext(Dispatchers.IO) {
            try {
                ...
                val response =
                    apiClient.get<ApiResponse<PaginatedNotificationResponse>>(
                        path = basePath,
    ...
    override suspend fun createNotification(notification: Notification): ApiResult<Notification> =
        withContext(
            ...
            try {
                ...
                val response =
                    apiClient.post<Map<String, kotlin.Any>, ApiResponse<NotificationResponse>>(
                        path = basePath,
                        body = request,
                    )
                return@withContext response.fold(
    ...
    override suspend fun markNotificationAsRead(id: String): ApiResult<Unit> =
        withContext(Dispatchers.IO) {
            try {
                val response =
                    apiClient.post<Unit, ApiResponse<Unit>>(
    ...
    override suspend fun markAllNotificationsAsRead(): ApiResult<Unit> =
        withContext(Dispatchers.IO) {
            try {
                ...
                val response =
                    apiClient.post<MarkAllReadRequest, ApiResponse<Unit>>(
                        path = "$basePath/read",
    ...
    override suspend fun deleteNotification(id: String): ApiResult<Unit> =
        withContext(Dispatchers.IO) {
            try {
                val response =
                    apiClient.delete<ApiResponse<Unit>>(
                        path = "$basePath/$id",
                    )
