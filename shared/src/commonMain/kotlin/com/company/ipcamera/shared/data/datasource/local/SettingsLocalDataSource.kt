...
interface SettingsLocalDataSource {
     ...
     */
    suspend fun getSettingByCategoryAndKey(
    ...
    /**
     * Обновить несколько настроек по ключу (key -> value).
     ...
     */
    suspend fun deleteSettingByCategoryAndKey(
        category: SettingsCategory,
        key: String,
    ): Result<Unit>
