...
typedef struct {
    ...
    int inputWidth;             // Ширина входа модели (416 или 640 для YOLO)
    int inputHeight;            // Высота входа модели
